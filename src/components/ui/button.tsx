  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neon: "bg-black/50 border border-neon-blue text-neon-blue shadow-neon-blue hover:shadow-neon-blue-hover hover:bg-black/70",
        "neon-green": "bg-black/50 border border-neon-green text-neon-green shadow-neon-green hover:shadow-neon-green-hover hover:bg-black/70",
        "neon-pink": "bg-black/50 border border-neon-pink text-neon-pink shadow-neon-pink hover:shadow-neon-pink-hover hover:bg-black/70",
      },
      size: {
